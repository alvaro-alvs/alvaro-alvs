...
export default function WebsiteDemoForm() {
...
<section className="bg-gray-50 dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div className="flex flex-col justify-center">
            ...
            <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Na OXX Digital Solutions, nos concentramos em oportunidades onde a tecnologia, a inovação e a inteligência digital podem gerar valor sustentável e impulsionar o crescimento do seu negócio</p>
            ...
            <div className="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                <form className="mt-8 space-y-6" action="#">
                    ...
                    <div className="flex items-start">
                        ...
                        <label htmlFor="remember" className="font-medium text-gray-500 dark:text-gray-400">Lembrar neste dispositivo</label>
                        </div>
                        <a href="#" className="ms-auto text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Esqueceu a senha?</a>
                    </div>
                    <button type="submit" className="w-full px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
                    <div className="text-sm font-medium text-gray-900 dark:text-white">
                        Não possui uma conta? <a className="text-blue-600 hover:underline dark:text-blue-500">Criar Conta</a>
                    </div>
                </form>
            </div>
        </div>
